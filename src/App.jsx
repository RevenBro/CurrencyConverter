...
function App() {
  return (
    <div className='py-5 px-6 sm:px-10 md:px-14 rounded-lg max-w-[410px] md:max-w-[600px] lg:max-w-[800px] mx-auto bg-[#02082d80] border border-solid border-[#ffffff4d] backdrop-blur-2xl shadow-md'>
      <h2 className='text-white text-[1.4rem] md:text-2xl font-semibold text-center'>Currency Converter</h2>
